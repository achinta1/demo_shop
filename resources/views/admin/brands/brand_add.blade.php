      ...
      <div class="modal-form-section">
        <div class="row">
						<div class="col-md-7 col-md-offset-2">
								{!! Form::open(array('url' => 'admin/brand-add','files'=>true,'name'=>'addBrandFrm','id'=>'addBrandFrm','role'=>'form')) !!}
									<div class="form-group">
										{!! Form::label('brand_name','Brand Name',['class'=>'control-label']) !!}
										{!! Form::text('brand_name', old('brand_name'), ['class'=>'form-control required', 'placeholder'=>'Enter Brand Name',
										'id'=>'BrandName',
										'autofocus']) 
										!!}
									</div>
									<div class="form-group">
										...
										{!! Form::text('order_position', old('order_position'), ['class'=>'form-control required', 'placeholder'=>'Enter Order Position',
										'id'=>'OrderPosition',
										'autofocus']) 
										!!}
									</div>
									<div class="form-group">
										{!! Form::label('brand_logo','Brand Logo',['class'=>'control-label']) !!}
										{!! Form::file('brand_logo',['class'=>'form-control required','id'=>'brand_logo','autofocus'])!!}
									</div>
									<div class="form-group">
...
$(document).ready(function(){
	$("#addBrandFrm").validate({
		...
		submitHandler:function(form){
			...
			$.post('<?php echo url('/admin/brandname-exists'); ?>',{"_token":$('meta[name="csrf-token"]').attr('content'),'brand_name':$('#BrandName').val()},function(rtn_data) {
