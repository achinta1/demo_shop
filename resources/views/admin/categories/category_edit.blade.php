        ...
        <div class="row">
					...
					<?php }else{?>
						<div class="col-md-7 col-md-offset-2">
								{!! Form::open(array('url' => 'admin/category-edit/'.$data['categories']->id,'files'=>true,'name'=>'editCategoryFrm','id'=>'editCategoryFrm','role'=>'form')) !!}
									{!! Form::hidden('id',$data['categories']->id) !!}
									<div class="form-group">
										{!! Form::label('name','Category Name',['class'=>'control-label']) !!}
										{!! Form::text('name', isset($data['categories']->name)?$data['categories']->name:old('name'), ['class'=>'form-control required', 'placeholder'=>'Enter Category Name',
										'id'=>'Name',
										'autofocus']) 
										!!}
									</div>
									...
									<div class="form-group">
										{!! Form::label('image','Category Logo',['class'=>'control-label']) !!}
										{!! Form::file('category_logo',['class'=>'form-control','id'=>'Image','autofocus'])!!}
									</div>
									<div class="form-group">
