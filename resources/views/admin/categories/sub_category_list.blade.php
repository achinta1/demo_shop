            ...
            <div class="col-lg-12">
                <h1 class="page-header page_title">
                    ...
                    <div class="header-btn">
                        <a href="javascript:void(0)" alt="Add" title="Add" data-toggle="modal" data-target="#ModalPopUpID" class="Modal-Pop-Link-Apr" data-href="{{ url('/admin/sub-category-add') }}"><button class="btn btn-success btn-bg-change">Add <?php echo isset($data['heading']) ? trim($data['heading']) :""; ?></button></a>
                    </div>
                </h1>
            </div>
            <div class="col-lg-12">
                    ...
                    <table class="table table-bordered" id="dataTablesApnd">
                        ...
                        <tr id="dataRow_<?php echo $category->id;?>">
                         <td align="center"><?php echo $counter;?></td>
												 <td align="center"><?php echo $category->parentcaregory->name;?></td>
                         <td align="center">
													<img src="{{URL::to('public/uploads/images/thumb/'.$category->image) }}"  style="margin-top:-9px" width="30%" height="50%" alt="">
												</td>
												<td align="center">{{$category->name }}</td>
                        <td align="center" class="actions">
													<a href="javascript:void(0)" alt="Add" title="Add" data-toggle="modal" data-target="#ModalPopUpID" class="Modal-Pop-Link-Apr" data-href="{{url('/admin/sub-category-edit/'.$category->id)}}"><i class="fa fa-pencil-square-o fa-lg"></i></a>
